...
import { sendMessage, getMessages, adminGetChat, getAllChats } from './chat.controller.js'; // Update the path as needed
...
chatRouter.get('/admin-get-all-chat', protectedRoutes, allowTo('user','admin'),getAllChats);
